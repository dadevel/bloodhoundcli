...
~~~ bash
bloodhoundcli db create project-1
bloodhoundcli db stop project-1
bloodhoundcli db create project-2
bloodhoundcli db stop project-2
...
bloodhoundcli ntds crack -t ./clem9669-wordlists/dictionnaire_de ./clem9669-hashcat-rules/clem9669_medium.rule -t ./custom-words.txt ./unicorn-hashcat-rules/unicorn\ rules/SuperUnicorn.rule -t ./weakpass-3.txt ./unicorn-hashcat-rules/unicorn\ rules/Unicorn250.rule -p ./hashcat.potfile ./*.ntds
~~~
...
~~~ bash
bloodhoundcli ntds import -p ./hashcat.potfile ./*.ntds
~~~
...
~~~ bash
bloodhoundcli netexec import ~/.nxc/workspaces/default/smb.db
~~~
